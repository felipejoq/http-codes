...
[![Live Site](https://img.shields.io/badge/Live-codes.uncodigo.com-blue?style=for-the-badge)](https://codes.uncodigo.com)
...
curl "https://codes.uncodigo.com/http/200?delay=2000"
...
```json
{
  ...
  "request": {
    ...
    "headers": { "accept": "*/*", "host": "codes.uncodigo.com" }
  }
}
```
